...
groupForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        let response = await axios.post('http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/createGroup', groupName, { headers: { Authorization: token } });
        console.log(response);
        location.reload();
    }
    catch (err) {
...
async function getMessages(groupId) {
    try {
        ...
        myTimer = setInterval(async () => {
            let response = await axios.get(`http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/message/getMessages?groupId=${groupId}&lastMessageId=${lastElementId}`, { headers: { Authorization: token } });
...
async function displayGroups() {
    let response = await axios.get('http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/getGroups', { headers: { Authorization: token } });
...
async function getGroupUsers(groupId) {
    let response = await axios.get(`http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/fetchUsers/${groupId}`, { headers: { Authorization: token } });
    let users = response.data;
    response = await axios.get(`http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/isAdmin/${groupId}`, { headers: { Authorization: token } });
...
userForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        let response = await axios.post(`http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/addUser`,userDetails, { headers: { Authorization: token } })
        console.log(response);
    }
    catch (err) {
        console.log(err);
...
async function removeUser(userId){
    ...
    try{
    let response = await axios.post(`http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/removeUser`,userDetails, { headers: { Authorization: token } })
...
async function makeAdmin(userId){
    let userDetails = {userId:userId,groupId:currentGroupId};
    try{
    let response = await axios.post(`http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/makeAdmin`,userDetails, { headers: { Authorization: token } })
...
async function removeAdmin(userId){
    let userDetails = {userId:userId,groupId:currentGroupId};
    try{
    let response = await axios.post(`http://ec2-44-203-27-62.compute-1.amazonaws.com:3000/group/removeAdmin`,userDetails, { headers: { Authorization: token } })
